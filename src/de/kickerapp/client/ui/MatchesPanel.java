...
public class MatchesPanel extends BasePanel {
	...
	public Grid<IMatch> createGrid() {
		...
		final ColumnConfig<IMatch, String> ccNumber = new ColumnConfig<IMatch, String>(matchProperty.matchNumber(), 200, "Nr.");
		...
		final ColumnConfig<IMatch, TeamDto> ccTeam1 = new ColumnConfig<IMatch, TeamDto>(matchProperty.team1(), 75, "Team 1");
		ccTeam1.setWidth(80);
		final ColumnConfig<IMatch, TeamDto> ccTeam2 = new ColumnConfig<IMatch, TeamDto>(matchProperty.team2(), 75, "Team 2");
		ccTeam2.setWidth(80);
		final ColumnConfig<IMatch, String> ccResult = new ColumnConfig<IMatch, String>(matchProperty.matchResult(), 75, "Ergebnis");
		...
		final ColumnModel<IMatch> cm = new ColumnModel<IMatch>(columns);
	...
	private void initPanelButtons() {
		final AppButton bGetMatches = new AppButton("Aktualisieren");
